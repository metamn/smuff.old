...
function fbc_render_login_state() {
  ...
  <tr>
  <td>    
    <fb:profile-pic uid="%d" facebook-logo="true" size="square"></fb:profile-pic></td>
  </td>
  <td>
    Ahoy, <fb:name uid="%d" capitalize="true" useyou="false"></fb:name>.
    <a onclick="FBConnect.logout(); return false" href="#">Logout</a>    
  </td>
  </tr></table>',$fbuid, $fbuid);
}
