...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" <?php language_attributes(); ?> >
    ...
    <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/style.css?refresh=20121029" type="text/css" media="screen" />
    ...
    <script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/js/jquery.init.js?refresh=20121029"></script>
