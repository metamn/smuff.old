...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" <?php language_attributes(); ?> >
    ...
    <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/style.css" type="text/css" media="screen" />
		<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/smuff.css?refresh=20121210a" type="text/css" media="screen" />
	    ...
	    <div class="block">	      
	      ...
	      <?php } ?>
			...
			<div id="menu-2" class="block">
				<ul class="inline-list">
					<li class="text">Categorii noi</li>
					...
					<li class="text search">Selectie dupa pret</li>
					<li>
						<form method="get" id="searchform" action="<?php bloginfo('home'); ?>/"> 
							<input type="hidden" value=" " name="s" id="s" /> 
							<select name="price">
								<option value="0-100000">Cautare fara pret</option>
								<option value="0-100">< 100 RON</option>
